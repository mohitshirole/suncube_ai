...
class BlockchainSecurityPage extends StatefulWidget {
  const BlockchainSecurityPage({super.key});

  @override
  State<BlockchainSecurityPage> createState() => _BlockchainSecurityPageState();
}

class _BlockchainSecurityPageState extends State<BlockchainSecurityPage> {
          ...
          children: [
            ...
            Container(
              ...
              child: Text(
                ...
                style: GoogleFonts.inter(
                  fontSize: 8.sp,
                  color: verified ? ecoG : Colors.orange,
                  fontWeight: FontWeight.w600,
                ),
              ),
            ),
  ...
  Widget _connector() =>
      Container(width: 20.w, height: 2.h, color: Colors.grey.withOpacity(0.3));
    ...
    children: [
      ...
      Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(color: border ?? Colors.grey.withOpacity(0.2)),
          borderRadius: BorderRadius.circular(4.r),
        ),
        child: Text(
          value,
