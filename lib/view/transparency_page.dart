...
class _TransparencyPageState extends State<TransparencyPage> {
  ...
  Widget _balanceCard() => Container(
    ...
    child: Column(
      ...
      children: [
        Row(
          children: [
            Icon(LucideIcons.chartBar200, color: lime, size: 18.sp),
            SizedBox(width: 6.w),
            Text(
              'Energy Balance',
              style: GoogleFonts.inter(
        ...
        SizedBox(height: 12.h),
        _balanceRow('Energy Earned', '1,247 kWh', ecoG),
        _balanceRow('Energy Consumed', '892.3 kWh', Colors.grey),
        Divider(color: Colors.white.withOpacity(0.2)),
        _balanceRow('Net Earnings', '+355.2 kWh', ecoG, bold: true),
      ],
    ),
  );
  ...
  Widget _exportCard() => Container(
    ...
    child: Column(
      ...
      children: [
        Row(
          children: [
            Icon(LucideIcons.download, color: lime, size: 18.sp),
            SizedBox(width: 6.w),
            Text(
              'Export Reports',
              style: GoogleFonts.inter(
  ...
  DataRow _dataRow(
    ...
    cells: [
      ...
      DataCell(
        IconButton(
          icon: Icon(LucideIcons.eye, size: 14.sp, color: Colors.white),
          onPressed: () {},
          padding: EdgeInsets.zero,
          constraints: const BoxConstraints(),
        ),
  ...
  Widget _roleSelector() => Container(
    ...
    child: Row(
      mainAxisSize: MainAxisSize.min,
      children: [
        Icon(LucideIcons.shield, size: 16.sp, color: lime),
        SizedBox(width: 6.w),
        Text(
          'Admin - Full Ledger Access',
          style: GoogleFonts.inter(
            fontSize: 10.sp,
            fontWeight: FontWeight.w500,
            color: Colors.white,
    ...
    child: Column(
      children: [
        ...
        GridView.count(
          ...
          crossAxisSpacing: 12.w,
          childAspectRatio: 1.1,
          children: [_digestLeft(), _digestRight()],
        ),
      ],
    ),
  );
  ...
  Widget _digestRight() => Column(
    children: [_emailOptions(), SizedBox(height: 12.h), _scheduleBtn()],
  );
  ...
  Widget _emailOptions() => Container(
    ...
    child: Column(
      ...
      children: [
        Row(
          children: [
            Icon(LucideIcons.mail, color: lime, size: 18.sp),
            SizedBox(width: 6.w),
            Text(
