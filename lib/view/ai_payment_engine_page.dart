...
class AiPaymentEnginePage extends StatefulWidget {
  const AiPaymentEnginePage({super.key});

  @override
  State<AiPaymentEnginePage> createState() => _AiPaymentEnginePageState();
}

class _AiPaymentEnginePageState extends State<AiPaymentEnginePage> {
  ...
  Widget _kpiCards() {
    final cards = [
      ...
      _kpiCard('Net Bill', '\$106.17', LucideIcons.fileText, lime, 'AI opt'),
    ];
    return Padding(
      padding: EdgeInsets.symmetric(horizontal: 16.w, vertical: 40.h),
      child: Column(
  ...
  Widget _kpiCard(
    ...
    decoration: BoxDecoration(
      ...
      gradient: LinearGradient(
        colors: [Colors.white.withOpacity(0.05), Colors.grey.withOpacity(0.1)],
        begin: Alignment.topLeft,
        end: Alignment.bottomRight,
      ),
    ),
  ...
  Widget _chart() => Padding(
    ...
    child: Column(
      children: [
        ListTile(
          dense: true,
          leading: Icon(LucideIcons.chartBar200, color: lime, size: 18.sp),
          title: Text(
  ...
  Widget _legend(Color c, String txt) => Row(
    mainAxisSize: MainAxisSize.min,
    children: [
      Container(
        width: 10.w,
      ...
      SizedBox(width: 4.w),
      Text(txt, style: GoogleFonts.inter(fontSize: 9.sp, color: Colors.white)),
    ],
  );
  ...
  Widget _aiLogic() => Container(
    ...
    child: Column(
      children: [
        ...
        SizedBox(height: 6.h),
        Text(
          'Our AI schedules payouts to avoid peak tariffs and maximize savings.',
          style: GoogleFonts.inter(
            fontSize: 12.sp,
            color: Colors.white.withOpacity(0.6),
          ),
  ...
  List<Widget> _logicItems() {
    final data = [
      ...
      (
        'Automated Execution',
        'Executes optimized payment schedule',
  ...
  Widget _aiBanner() => Container(
    ...
    child: Row(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Icon(LucideIcons.brain, color: lime, size: 16.sp),
        SizedBox(width: 8.w),
        Expanded(
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
